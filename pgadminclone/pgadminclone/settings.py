"""
Django settings for pgadminclone project.
...
SECRET_KEY = 'django-insecure-hx60lmq^2reus^m5th0od%h4v@ry--knsm!ij7*yp72(#%x5%&'
...
ROOT_URLCONF = 'pgadminclone.urls'
...
WSGI_APPLICATION = 'pgadminclone.wsgi.application'
